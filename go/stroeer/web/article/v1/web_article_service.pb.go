...
type WebArticlePageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WebArticlePageResponse) Reset() {
	*x = WebArticlePageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *WebArticlePageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WebArticlePageResponse) ProtoMessage() {}

func (x *WebArticlePageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_stroeer_web_article_v1_web_article_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WebArticlePageResponse.ProtoReflect.Descriptor instead.
func (*WebArticlePageResponse) Descriptor() ([]byte, []int) {
	return file_stroeer_web_article_v1_web_article_service_proto_rawDescGZIP(), []int{1}
}

func (x *WebArticlePageResponse) GetWebArticle() *WebArticle {
	if x != nil {
		return x.WebArticle
	}
	return nil
...
func (x *WebArticlePageResponse) GetRelatedWebArticles() []*RelatedWebArticle {
	if x != nil {
...
var file_stroeer_web_article_v1_web_article_service_proto_rawDesc = []byte{
	...
	,
	...
	0x2f, 0x77, 0x65, 0x62, 0x2f, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x2f, 0x76, 0x31, 0x3b,
...
var file_stroeer_web_article_v1_web_article_service_proto_goTypes = []interface{}{
	...
	(*WebArticlePageResponse)(nil),   // 1: stroeer.web.article.v1.WebArticlePageResponse
...
var file_stroeer_web_article_v1_web_article_service_proto_depIdxs = []int32{
	2, // 0: stroeer.web.article.v1.WebArticlePageResponse.web_article:type_name -> stroeer.web.article.v1.WebArticle
	3, // 1: stroeer.web.article.v1.WebArticlePageResponse.related_web_articles:type_name -> stroeer.web.article.v1.RelatedWebArticle
	...
	1, // 3: stroeer.web.article.v1.WebArticleService.GetWebArticlePage:output_type -> stroeer.web.article.v1.WebArticlePageResponse
...
func file_stroeer_web_article_v1_web_article_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stroeer_web_article_v1_web_article_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WebArticlePageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type WebArticleServiceClient interface {
	...
	GetWebArticlePage(ctx context.Context, in *GetWebArticlePageRequest, opts ...grpc.CallOption) (*WebArticlePageResponse, error)
}
...
func (c *webArticleServiceClient) GetWebArticlePage(ctx context.Context, in *GetWebArticlePageRequest, opts ...grpc.CallOption) (*WebArticlePageResponse, error) {
	out := new(WebArticlePageResponse)
...
type WebArticleServiceServer interface {
	// Returns an Article page including all (SEO) relevant information to
	// render an Article with the given id as canonical web or AMP
	GetWebArticlePage(context.Context, *GetWebArticlePageRequest) (*WebArticlePageResponse, error)
}
...
func (*UnimplementedWebArticleServiceServer) GetWebArticlePage(context.Context, *GetWebArticlePageRequest) (*WebArticlePageResponse, error) {
